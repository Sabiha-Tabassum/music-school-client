...
const About = () => {
    return (
        <Container>
            <div className='md:flex mb-4 mt-8'>
                <motion.div animate ={{x: 100, }} transition={{delay: 0, duration: 2}}>
                ...
                <div className='ml-24 '>
                    ...
                    <motion.div animate={{x: -90}} transition={{delay: 0, duration: 2}} className='flex ml-20'>
